...
<body>
    <section id="container">
        ...
        <div class="sideBar">
            ...
            <div class="dashBoard"style="cursor:pointer;"onclick="document.location='../view/controlCenter.php'"><h1><a href="../view/controlCenter.php">Dashboard</a></h1></div>
            <div class="addProject"style="cursor:pointer;"onclick="document.location='../view/addProduct.php'"><h1><a href="../view/addProduct.php">Add Product</a></h1></div>
            <div class="editProject"style="cursor:pointer;"onclick="document.location='../view/editDelete.php'"><h1><a href="../view/editDelete.php">Edit/Delete Products</a></h1></div>
            <div class="editProject"style="cursor:pointer;"onclick="document.location='../view/checkEvent.php'"><h1><a href="../view/checkEvent.php">Check Orders</a></h1></div>
            <div class="editProject"style="cursor:pointer;"onclick="document.location='../view/addCategory.php'"><h1><a href="../view/addCategory.php">Add Category</a></h1></div>
            <div class="editProject"style="cursor:pointer;"onclick="document.location='../view/deleteCategory.php'"><h1><a href="../view/deleteCategory.php">Delete Category</a></h1></div>
